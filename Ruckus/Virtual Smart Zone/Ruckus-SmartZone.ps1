...
function Get-GetAPClientConnectedTo
{
    ...
    $Body = "{`"filters`":[{`"type`":`"DOMAIN`",`"value`":`"SNIP`"}],`"fullTextSearch`":{`"type`":`"AND`",`"value`":`""+$Client+"`"},`"attributes`":[`"*`"],`"sortInfo`":{`"sortColumn`":`"clientMac`",`"dir`":`"ASC`"},`"page`":1,`"limit`":8}"
...
Get-GetAPClientConnectedTo -Uri "SNIP" -Client "F8:1F:32:15:32:26"
